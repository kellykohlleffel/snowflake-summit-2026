...
The lab demonstrates ODI in action: move, manage with data moving into open formats (Iceberg), and cataloged in open governance (Polaris/Horizon), and compute-agnostic along with transform (dbt models, views, semantic views) and move again (activate). The same data could be queried by any Iceberg-compatible engine. Predictability and standardization with openness and optionality.
...
*Date: March 2026*
*Status: Concept — for Marketing review*
